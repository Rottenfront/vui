...
pub trait Modifiers: View + Sized {
    ...
    fn drag<F: Fn(&mut Context, Vec2, GestureState, Option<MouseButton>) + Clone + 'static>(
        self,
        f: F,
    ...
    fn drag_p<F: Fn(&mut Context, Point, GestureState, Option<MouseButton>) + Clone + 'static>(
        self,
        f: F,
    ...
    fn drag_s<
        T: Clone + 'static,
        B: Binding<T>,
        F: Fn(&mut T, Vec2, GestureState, Option<MouseButton>) + Clone + 'static,
    >(
        self,
        b: B,
        f: F,
    ...
    fn hover_p<A: 'static, F: Fn(&mut Context, Point) -> A + Clone + 'static>(
        self,
        f: F,
    ...
    fn geom<F: Fn(&mut Context, Size) + Clone + 'static>(self, f: F) -> Geom<Self, F> {
        Geom::new(self, f)
    }
    ...
    fn offset(self, offset: impl Into<Vec2>) -> Offset<Self> {
    ...
    fn sized(self, size: impl Into<Size>) -> SizeView<Self> {
        SizeView::new(self, size.into())
    }
    ...
    fn tap_p<A: 'static, F: Fn(&mut Context, Point, Option<MouseButton>) -> A + Clone + 'static>(
        self,
        f: F,
